...
import com.hokidachi.common.entity.AbstractAddress;
...
public class Order extends AbstractAddress {
    ...
    public void copyAddressFromCustomer() {
        ...
        setVillage(customer.getVillage());
    ...
    public String toString() {
        return "Order [id=" + id + ", Tổng tiền =" + subtotal + ", Phương thức thanh toán=" + paymentMethod + ", Trạng thái=" + status
                + ", Khách hàng=" + customer.getFullName() + "]";
    }

    @Transient
    public String getDestination() {
        String destination =  village + ", ";
