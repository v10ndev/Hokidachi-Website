...
public class ProductRepositoryTests {
    ...
    public void testCreateProduct() {
        ...
        product.setName("Cây cảnh Golden Gate");
        product.setAlias("golden_gate");
        product.setShortDescription("Miêu tả ngắn về Golden Gate");
        product.setFullDescription("Miêu tả cụ thể viết ở đây...");
