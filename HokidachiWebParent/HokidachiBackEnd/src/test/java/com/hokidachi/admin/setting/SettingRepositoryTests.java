...
public class SettingRepositoryTests {
    ...
    public void testCreateGeneralSettings() {
        Setting siteName = new Setting("SITE_NAME", "Hokidachi", SettingCategory.GENERAL);
        Setting siteLogo = new Setting("SITE_LOGO", "Hokidachi.png", SettingCategory.GENERAL);
        Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Hokidachi Ltd.", SettingCategory.GENERAL);
