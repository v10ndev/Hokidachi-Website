...
public class AccountController {
    ...
    @GetMapping("/account")
    public String viewDetails(@AuthenticationPrincipal HokidachiUserDetails loggedUser, Model model) {
    ...
    public String saveDetails(User user, RedirectAttributes redirectAttributes,
        ...
        redirectAttributes.addFlashAttribute("message", "Chi tiết tài khoản của bạn đã được cập nhật.");
