...
import com.hokidachi.setting.CityRepository;
...
public class CustomerService {
    ...
    public void addNewCustomerUponOAuthLogin(String name, String email, String cityCode,
        ...
        customer.setCity(cityRepo.findByCode(cityCode));
